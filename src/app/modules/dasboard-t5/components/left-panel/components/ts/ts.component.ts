...
@Component({
  ...
  imports: [NuanceInforComponent,TableLLComponent,TableKGMComponent, TablePtmV2Component, CommonModule, ChuthichComponent, NzDatePickerModule, FormsModule,HeaderChartV2Component, HeaderChartComponent, BieuDoBvTieuCucComponent, TablePtmComponent, HotTopicComponent, LineChartComponent, ViralPostsComponent, LivestreamWarningComponent, PieChartComponent, CustomTableComponent, StackChart],
})
