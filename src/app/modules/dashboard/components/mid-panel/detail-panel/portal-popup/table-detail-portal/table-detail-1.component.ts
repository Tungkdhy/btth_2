...
export class TableDetail1Component {
  ...
  async onPageChange(page: number) {
    this.page = page;
    let data = await this.supabase.getTableUDDVPopupMidPanel(this.mainType,this.subType,"PORTAL",this.convertService.getRegionType(this.regionType),this.searchText,this.statusType,page,this.pageSize);
  ...
  async search(){
    ...
    let data = await this.supabase.getTableUDDVPopupMidPanel(this.mainType,this.subType,"PORTAL",this.convertService.getRegionType(this.regionType),this.searchText,this.statusType,1,this.pageSize);
    this.dataSource = data?.items;
  ...
  async exportExcel() {
    let data = await this.supabase.getTableUDDVPopupMidPanel(this.mainType,this.subType,"PORTAL",this.convertService.getRegionType(this.regionType),this.searchText,this.statusType,1,99999);
    // this.dataSource = data?.items;
    let data_sheet = [];
    ...
    this.excelService.exportExcel(data_sheet, 'Cổng TTĐT');
  }
