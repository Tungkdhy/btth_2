...
@Component({
  ...
  styleUrls: ['./portal-popup.component.scss']
})
export class PortalPopupComponent implements OnInit,OnChanges {
  constructor(
...
async getData(){
  ...
  //   }
  // }
  let thongKeEndPoint = await this.supabase.getBieuDoTronUDDVPopupMidPanel(this.mainType,this.subType,"PORTAL", this.convertService.getRegionType(this.regionType));
    ...
    let danhSachThongKeMatKetNoiThietBi:any = await this.supabase.getBIeuDoCotUDDVPopupMidPanel(this.mainType,this.subType,"PORTAL", this.convertService.getRegionType(this.regionType));
    ...
    let tempTable:any  = await this.supabase.getTableUDDVPopupMidPanel(this.mainType,this.subType,"PORTAL", this.convertService.getRegionType(this.regionType));
