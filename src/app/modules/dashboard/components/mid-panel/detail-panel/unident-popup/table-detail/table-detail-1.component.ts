...
export class TableDetail1Component {
  ...
  async onPageChange(page: number) {
    this.page = page;
    let data:any = await this.supabase.trienKhaiGiaiPhapATTTTrenThietBiDauCuoi(this.mainType,this.subType,this.convertService.getRegionType(this.regionType),null,this.selectedValues,2,this.isClickTrongNgay,this.searchText,this.statusType,this.startDate,this.endDate,page,this.pageSize);
  ...
  async onChange(event: ChangeEventArgs) {
    ...
    let data:any = await this.supabase.trienKhaiGiaiPhapATTTTrenThietBiDauCuoi(this.mainType,this.subType,this.convertService.getRegionType(this.regionType),null,this.selectedValues,2,this.isClickTrongNgay,this.searchText,this.statusType,this.startDate,this.endDate);
...
async exportExcel() {
  let data: any = await this.supabase.trienKhaiGiaiPhapATTTTrenThietBiDauCuoi(this.mainType,this.subType,this.convertService.getRegionType(this.regionType),null,this.selectedValues,2,this.isClickTrongNgay,this.searchText,this.statusType,this.startDate,this.endDate,1,99999);
  // this.dataSource = data?.items;
  let data_sheet = [];
  ...
  this.excelService.exportExcel(data_sheet, 'Thiết bị chưa định danh');
